...
import { Mail, Phone, MapPin, Globe, Award, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-lg border border-gray-100 shadow-sm overflow-hidden">
        <div className="h-28 bg-gray-900 text-white flex items-center justify-center font-bold text-8xl">HACKATHON RAT</div>
        <div className="px-8 pb-8">
          <div className="relative flex items-end -mt-12 mb-6">
            <img
              src={profile.avatar || "../public/clubprofiles/ns.png"}
              alt={profile.name}
